...
- 🚀 **Vercel 部署** - 自动部署到 Vercel，生成预览 URL
- 📱 **响应式设计** - 完美支持桌面、平板、手机
...
OpenClaw Workspace 集成了 Vercel 自动部署功能：

**配置步骤**：
1. 获取 Vercel Access Token：https://vercel.com/account/tokens
2. 在 `.env` 文件中配置 `VERCEL_TOKEN`
3. 在项目设置中输入 Vercel Project ID
4. 推送代码后自动触发部署

**详细文档**：参见 [Vercel 集成配置指南](./docs/VERCEL_SETUP.md)
...
- `stores/project.ts` - GitHub 项目和 Vercel 部署状态
